...
rm(list=ls())
getwd()
setwd("~/Github/QB2017_Gibson/Week3-Beta")
library(vegan)
...
> ***Answer 2b***:  Brown trout abundance is higher towards the upstream than the downstream. This differences between the two sides of the river are very extreme...with abundance values of mostly 0 on the downstream side. 
> ***Answer 2c***:  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
> ***Answer 3a***:  They are multiplicative. $\gamma = \beta \alpha$. 
